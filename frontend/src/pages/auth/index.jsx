      ...
      >
        ...
        <TabsContent value="signin">
          <Card className="bg-zinc-950 text-white border-zinc-700">
            <CardHeader>
              <CardTitle className="text-2xl font-normal">Sign in to your account</CardTitle>
              <CardDescription>
                Enter your email and password to access your account
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              <Form formControl={SigninController} buttonText="Sign in" />
            </CardContent>
          </Card>
        </TabsContent>
        <TabsContent value="signup">
          <Card className="bg-zinc-950 text-white border-zinc-700">
            <CardHeader>
              <CardTitle className="text-2xl font-normal">Create a new account</CardTitle>
              <CardDescription>
                Enter your details to get started
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              <Form formControl={SignupController} buttonText="Sign up" />
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
